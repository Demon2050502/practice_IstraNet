...
│ │
│ ├── pkg/
│ │ ├── handler/ # Тут будет роутер и бизнес логика
│ │ │ ├── auxiliary_paths/ # вспомогательные функции(работа с токеном)
│ │ │ ├─── main_paths/ # основые функции
│ │ │ │ └─── interface.go # содежить интерфейсы с функциями для роутера
│ │ │ └── handler.go # роутер
│ │ │
│ │ ├── dto/ # DTO-структуры для API
...
- Управление справочниками (админ) - так же сюда можно будет добавить упраылением категориями и приоритетом
